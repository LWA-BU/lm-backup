        ...
        <article class="cuisines-section">
            <img class="cuisines-section__img-large"   
                ...
                srcset="<?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-moderne-480.jpg 480w,
                        <?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-moderne-768.jpg 768w,
                        <?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-moderne-1200.jpg 1200w"
                sizes="<?php echo $sizes ?>"
                src="<?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-moderne-1200.jpg"
        ...
        <article class="cuisines-elegantes cuisines-section ">
            <img class="cuisines-section__img-large cuisines-section__img-large-r" 
                srcset="<?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-elegante-480.jpg 480w,
                        ...
                        <?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-elegante-1200.jpg 1200w"
                sizes="<?php echo $sizes ?>"
                src="<?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-elegante-1200w.jpg"        
        ...
        <article class="cuisines-minimalistes cuisines-section ">
            <img class="cuisines-section__img-large cuisines__img-first cuisines__img-left"  
                srcset="<?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-minimaliste-480.jpg 480w,
                        ...
                        <?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-minimaliste-1200.jpg 1200w"
                sizes="<?php echo $sizes ?>"
                src="<?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-minimaliste-1200w.jpg" 
                alt="Cuisine minimaliste bois blanc mat et beige, niche en bois couleur chêne">
            <div class="cuisines-section__content cuisines-content">
                <div class="cuisines-minimalistes__content cuisines-txt">
                    <h2 class="cuisines-minimalistes__content-title cuisines-title-black">Minimaliste</h2>
        ...
        <article class="cuisines-natures cuisines-section ">
            <img class="cuisines-section__img-large cuisines-section__img-large-r" 
                srcset="<?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-nature-480.jpg 480w,
                            ...
                            <?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-nature-1200.jpg 1200w"
                sizes="<?php echo $sizes ?>"
                src="<?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-nature.webp" 
                alt="Cuisine aux couleurs nature beige, vert d'eau et son plan de travail blanc cassé ">
            <div class="cuisines-section__content-right cuisines-content">
                <div class="cuisines-natures__content cuisines-txt">
                    <h2 class="cuisines-natures__content-title cuisines-title-beige">Nature</h2>
                    <p class="cuisines-natures__content-txt cuisines-paragraphe paragraphe">
                        ...
                        Le mariage des couleurs et formes douces procure un sentiment de bien-être, où chaque élément rappelle la tranquillité et l’harmonie de la nature. »
                    </p>
                </div>                        
        ...
        <article class="cuisines-chaleureuses cuisines-section">
            <img class="cuisines-section__img-large cuisines__img-first cuisines__img-left" 
                srcset="<?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-chaleureuse-480.jpg 480w,
                        ...
                        <?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-chaleureuse-1200.jpg 1200w"
                sizes="<?php echo $sizes ?>"
                src="<?php echo get_template_directory_uri(); ?>/assets/img/cuisines/cuisine-chaleureuse.webp" 
                alt="Cuisine aux couleurs nature beige, vert d'eau et son plan de travail blanc cassé ">
            <div class="cuisines-section__content cuisines-content">
                <div class="cuisines-chaleureuses__content cuisines-txt">
                    <h2 class="cuisines-chaleureuses__content-title cuisines-title-black">Chaleureuse</h2>
