...
const toggleMenuState = (parent, isOpen) => {
  ...
  iconMenu.src = isOpen
    ? 'http://localhost:8888/lm-menuisier/wp-content/themes/lawebavenue/assets/img/up-arrow.png'
    : 'http://localhost:8888/lm-menuisier/wp-content/themes/lawebavenue/assets/img/down-arrow.png';
