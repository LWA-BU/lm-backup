<?php get_header(); ?>
    <main>
        <section class="section-about">
            ...
            <div class="section-about__content">
                ...
                <p class="section-about__p paragraphe">
                    ...
                    Cette dernière est reconnue pour cultiver des valeurs éthiques d’excellence, de la richesse de l’expérience pratique et de la transmission des savoir-faire.  
        ...
        <section class="section-customMade">
            <img src="" alt="" class="section-customMade__icone" aria-hidden="true">
        ...
        <section class="section-concept">
            <img src="" alt="" class="section-concept__img">
            <span class="section-concept-bgDeco" aria-hidden="true"></span>
            <img src="" alt="" class="section-concept__imgDeco" aria-hidden="true"">
            <div class="section-concept__title">
                <img src="" alt="" class="section-concept__title-img">
                <h1 class="section-concept__title-title section-title">Concevoir le projet</h1>
            </div>
            <p class="section-concept__p"></p>
            <ul class="section-concept__list">
                <li class="section-concept__list-item list-definition"></li>
                <li class="section-concept__list-item list-measure"></li>
                <li class="section-concept__list-item list-feasibility"></li>
                <li class="section-concept__list-item list-choice"></li>
